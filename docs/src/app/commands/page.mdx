...
```bash
agent-browser dashboard [start]       # Start the dashboard server (default: 0.0.0.0:4848)
agent-browser dashboard start --host <addr>  # Start on a specific host/interface
