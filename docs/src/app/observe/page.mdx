...
Then open `http://<server-host>:4848` in your browser to see the live dashboard. The dashboard binds to `0.0.0.0` by default; use `--host` to restrict it to a specific interface.
